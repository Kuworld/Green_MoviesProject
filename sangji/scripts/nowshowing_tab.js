function nowshowingHTML() {
  ...
  var posters = document.querySelectorAll('.poster[data-year="2024"]');
  ...
  nowshowingtabarea.appendChild(ul);
  ...
  nowshowingtabarea.appendChild(moreButton); 
  ...
  nowshowingtabarea.appendChild(listcount);
  ...
  nowshowingtabimage.style.opacity = "1";
