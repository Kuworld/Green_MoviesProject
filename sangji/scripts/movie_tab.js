function movieHTML() {
  ...
  var posters = document.querySelectorAll('.poster[data-category="movie"]');
  ...
  movietabarea.appendChild(moreButton); 
  ...
  movietabarea.appendChild(listcount);
